...
resp1 = conversation_chain.invoke({"input": "My name is Francisco. Reply only with 'OK' and do not mention my name."}, config=config)
print("Assistant: ", resp1.content)
print("-"*30)

resp2 = conversation_chain.invoke({"input": "Tell me one-sentence fun fact. Do not mention my name"}, config=config)
print("Assistant: ", resp2.content)
print("-"*30)

resp3 = conversation_chain.invoke({"input": "What is my name?"}, config=config)
