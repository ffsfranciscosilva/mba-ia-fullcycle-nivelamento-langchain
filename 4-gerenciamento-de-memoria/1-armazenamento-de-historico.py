...
# Interaction
response1 = conversational_chain.invoke({"input": "Hello, my name is Francisco. How are you?"}, config=config)
print("Assistent", response1.content)
print("-"*30)

response2 = conversational_chain.invoke({"input": "Can you repeat my name?"}, config=config)
print("Assistent", response2.content)
print("-"*30)

response3 = conversational_chain.invoke({"input": "Can you repeat my name in a motivation phrase?"}, config=config)
print("Assistent", response3.content)
print("-"*30)
